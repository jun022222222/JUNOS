return {
	Jos = {
		{Text = "jun022222222",				Desc = "Manage J'os system and Contributed Adonis system"};
		{Text = "",							Desc = ""};
		{Text = "CoasterTeam & Irreflexive",	Desc = "Theme and Miscs and more inspired by Kronos Administration system for PB"};
		{Text = "",							Desc = ""};
		{Text = "Special Thanks",			Desc = "everybody who helped in development"};
		{Text = "Donors",					Desc = "Thanks for supporting me :)"};
	};
